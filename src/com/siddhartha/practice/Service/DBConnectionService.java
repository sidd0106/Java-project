...
/**
 * Database connection service class to create,close and manage connection to a database.
 * Singleton class to avoid multiple instance of same database connection.
 */
